fExtDepSpat <- function(x, model, sites, hit, jw, thresh, DoF, range, smooth, alpha, par0,
  ...
  if (jw > Ns) {
    stop("'jw' cannot be greater than the number of 'sites'.")
  }
  if (jw < Ns) {
    if (missing(thresh)) {
  ...
  if (model == "ET") {
    if (missing(DoF) && missing(smooth) && missing(range)) {
      if (length(par0) != 3) {
        stop("'par0' should be of length 3")
      }
    ...
    if (missing(DoF) && missing(smooth) && !missing(range)) {
      if (length(par0) != 2) {
        stop("'par0' should be of length 2")
      }
    ...
    if (!missing(DoF) && !missing(smooth) && missing(range)) {
      if (length(par0) != 1) {
        stop("'par0' should be of length 1")
      }
      par0 <- log(par0)
      control$parscale <- 1
    }
  ...
  if (model == "EST") {
    if (missing(DoF) && missing(range) && missing(smooth) && missing(alpha)) {
      if (length(par0) != 6) {
        stop("'par0' should be of length 6")
      }
      ...
      if (length(par0) != 5) {
        stop("'par0' should be of length 5")
      }
      ...
      if (any(is.na(alpha))) {
        ...
        if (length(ind) == 1) {
          ...
          if (length(par0) != 4) {
            stop("'par0' should be of length 4")
          }
    ...
    if (jw == Ns) { # Full likelihood
      ...
      if (missing(DoF) && missing(smooth) && missing(range)) {
        nllh_tmp <- function(param, z, hit) {
          ...
          if (round(inv.logit(param[3]), 6) == 0 || round(inv.logit(param[3]), 6) == 1) {
            return(Inf)
          }
          nllh_et(
            par = param, z = z, sites = sites, hit = hit,
        ...
        nllh_tmp <- function(param, z, hit) {
          ...
          if (round(inv.logit(param[2]), 6) == 0 || round(inv.logit(param[2]), 6) == 1) {
            return(Inf)
          }
          nllh_etr(
            par = param, range = range, z = z, sites = sites, hit = hit,
            split = FALSE, parallel = parallel,
            pfun = mypmvt, args1 = args1, args2 = args2, seed = seed
          )
        }
        ...
        nllh_tmp <- function(param, z, hit) {
          ...
          nllh_etf(
            par = param, lDoF = log(DoF), z = z, sites = sites, hit = hit,
            split = FALSE, parallel = parallel,
            pfun = mypmvt, args1 = args1, args2 = args2, seed = seed
          )
        }
        ...
        nllh_tmp <- function(param, z, hit) {
          if (round(inv.logit(param), 6) == 0 || round(inv.logit(param), 6) == 1) {
            return(Inf)
          }
          nllh_etfr(
            par = param, lDoF = log(DoF), z = z, sites = sites, hit = hit,
        ...
        nllh_tmp <- function(param, z, hit) {
          ...
          nllh_etsr(
            par = param, smooth = smooth, z = z, sites = sites, hit = hit,
            range = range, split = FALSE, parallel = parallel,
            pfun = mypmvt, args1 = args1, args2 = args2, seed = seed
          )
        }
    ...
    if (jw == Ns) { # Full likelihood
      ...
      if (missing(DoF) && missing(range) && missing(smooth) && missing(alpha)) {
        ...
        nllh_tmp <- function(param, z, hit) {
          ...
          nllh_estf(
            par = param, z = z, lDoF = log(DoF), sites = sites, hit = hit,
            acov1 = acov1, acov2 = acov2,
            split = FALSE, parallel = parallel,
            pfun = mypmvsext, args1 = args1, args2 = args2, seed = seed
          )
        ...
        nllh_tmp <- function(param, z, hit) {
          ...
          nllh_estr(
            par = param, z = z, range = range, sites = sites, hit = hit,
            acov1 = acov1, acov2 = acov2,
            split = FALSE, parallel = parallel,
            pfun = mypmvsext, args1 = args1, args2 = args2, seed = seed
          )
        ...
        nllh_tmp <- function(param, z, hit) {
          ...
          nllh_ests(
            par = param, z = z, smooth = smooth, sites = sites, hit = hit,
            acov1 = acov1, acov2 = acov2,
            split = FALSE, parallel = parallel,
            pfun = mypmvsext, args1 = args1, args2 = args2, seed = seed
          )
        ...
        nllh_tmp <- function(param, z, hit) {
          ...
          if (any(is.na(alpha))) {
            ...
            if (length(ind) == 1) {
              if (ind == 1) {
                nllh_esta0(
                  par = param, z = z, alpha = alpha, sites = sites, hit = hit,
                  acov1 = acov1, acov2 = acov2,
                  split = FALSE, parallel = parallel,
                  pfun = mypmvsext, args1 = args1, args2 = args2, seed = seed
                )
        ...
        nllh_tmp <- function(param, z, hit) {
          if (round(inv.logit(param[1]), 6) == 0 || round(inv.logit(param[1]), 6) == 1) {
            return(Inf)
          }
          nllh_estfr(
            par = param, z = z, lDoF = log(DoF), range = range, sites = sites, hit = hit,
            acov1 = acov1, acov2 = acov2,
            split = FALSE, parallel = parallel,
            pfun = mypmvsext, args1 = args1, args2 = args2, seed = seed
          )
        ...
        nllh_tmp <- function(param, z, hit) {
          ...
          nllh_estfs(
            par = param, z = z, lDoF = log(DoF), smooth = smooth, sites = sites, hit = hit,
            acov1 = acov1, acov2 = acov2,
            split = FALSE, parallel = parallel,
            pfun = mypmvsext, args1 = args1, args2 = args2, seed = seed
          )
        ...
        nllh_tmp <- function(param, z, hit) {
          ...
          if (any(is.na(alpha))) {
            ...
            if (length(ind) == 1) {
              if (ind == 1) {
                nllh_estfa0(
                  par = param, z = z, lDoF = log(DoF), alpha = alpha, sites = sites, hit = hit,
                  acov1 = acov1, acov2 = acov2,
                  split = FALSE, parallel = parallel,
                  pfun = mypmvsext, args1 = args1, args2 = args2, seed = seed
                )
        ...
        nllh_tmp <- function(param, z, hit) {
          ...
          nllh_estrs(
            par = param, z = z, range = range, smooth = smooth, sites = sites, hit = hit,
            acov1 = acov1, acov2 = acov2,
            split = FALSE, parallel = parallel,
            pfun = mypmvsext, args1 = args1, args2 = args2, seed = seed
          )
        ...
        nllh_tmp <- function(param, z, hit) {
          ...
          if (any(is.na(alpha))) {
            ...
            if (length(ind) == 1) {
              if (ind == 1) {
                nllh_estra0(
                  par = param, z = z, range = range, alpha = alpha, sites = sites, hit = hit,
                  acov1 = acov1, acov2 = acov2,
                  split = FALSE, parallel = parallel,
                  pfun = mypmvsext, args1 = args1, args2 = args2, seed = seed
                )
        ...
        nllh_tmp <- function(param, z, hit) {
          ...
          if (any(is.na(alpha))) {
            ...
            if (length(ind) == 1) {
              if (ind == 1) {
                nllh_estsa0(
                  par = param, z = z, smooth = smooth, alpha = alpha, sites = sites, hit = hit,
                  acov1 = acov1, acov2 = acov2,
                  split = FALSE, parallel = parallel,
                  pfun = mypmvsext, args1 = args1, args2 = args2, seed = seed
                )
        ...
        nllh_tmp <- function(param, z, hit) {
          nllh_estfrs(
            par = param, z = z, lDoF = log(DoF), range = range, smooth = smooth, sites = sites, hit = hit,
            acov1 = acov1, acov2 = acov2,
            split = FALSE, parallel = parallel,
            pfun = mypmvsext, args1 = args1, args2 = args2, seed = seed
          )
        ...
        nllh_tmp <- function(param, z, hit) {
          ...
          if (any(is.na(alpha))) {
            ...
            if (length(ind) == 1) {
              if (ind == 1) {
                nllh_estfra0(
                  par = param, z = z, lDoF = log(DoF), range = range, alpha = alpha, sites = sites, hit = hit,
                  acov1 = acov1, acov2 = acov2,
                  split = FALSE, parallel = parallel,
                  pfun = mypmvsext, args1 = args1, args2 = args2, seed = seed
                )
        ...
        nllh_tmp <- function(param, z, hit) {
          ...
          if (any(is.na(alpha))) {
            ...
            if (length(ind) == 1) {
              if (ind == 1) {
                nllh_estfsa0(
                  par = param, z = z, lDoF = log(DoF), smooth = smooth, alpha = alpha, sites = sites, hit = hit,
                  acov1 = acov1, acov2 = acov2,
                  split = FALSE, parallel = parallel,
                  pfun = mypmvsext, args1 = args1, args2 = args2, seed = seed
                )
        ...
        nllh_tmp <- function(param, z, hit) {
          ...
          if (any(is.na(alpha))) {
            ...
            if (length(ind) == 1) {
              if (ind == 1) {
                nllh_estrsa0(
                  par = param, z = z, range = range, smooth = smooth, alpha = alpha, sites = sites, hit = hit,
                  acov1 = acov1, acov2 = acov2,
                  split = FALSE, parallel = parallel,
                  pfun = mypmvsext, args1 = args1, args2 = args2, seed = seed
                )
        ...
        nllh_tmp <- function(param, z, hit) {
          if (any(is.na(alpha))) {
            ...
            if (length(ind) == 1) {
              if (ind == 1) {
                nllh_estfrsa0(
                  par = param, z = z, lDoF = log(DoF), range = range, smooth = smooth, alpha = alpha, sites = sites, hit = hit,
                  acov1 = acov1, acov2 = acov2,
                  split = FALSE, parallel = parallel,
                  pfun = mypmvsext, args1 = args1, args2 = args2, seed = seed
                )
  ...
  if (sandwich) {
    ...
    fun <- function(par) {
      nllh_tmp(param = par, z = x, hit = hit)
    }
    bread <- fdhessian(fun = fun, par = xx$par, epsVec = epsVec)

    for (i in 1:nrow(x)) {
      funi <- function(par) {
        nllh_tmp(param = par, z = matrix(x[i, ], nrow = 1), hit = matrix(hit[i, ], nrow = 1))
      }
    ...
    if (is.null(INVbread)) {
      INVbread <- tryCatch(solve(bread), error = function(e) NULL)
    }
    if (is.null(INVbread)) {
      stop("Cannot invert the bread matrix in sandwich information matrix")
    }
...
nllh_et <- function(par, z, sites, hit, split = FALSE, parallel = FALSE,
  ...
  par <- par[1:2]
  nllh_ets(
    par = par, z = z, sites = sites, hit = hit, smooth = smooth, split = split, parallel = parallel,
...
nllh_etfr <- function(par, range, lDoF, z, sites, hit, split = FALSE, parallel = FALSE,
  ...
  nllh_ets(
    par = c(lDoF, log(range)), z = z, sites = sites, hit = hit, smooth = smooth, split = split, parallel = parallel,
    pfun = pfun, args1 = args1, args2 = args2, seed = seed
  )
}
  ...
  if (!split) {
    if (parallel) {
      nllhjw <- foreach(i = 1:njw, .combine = c, .packages = "foreach", .export = c("nllh_et", "convertHit", "vfun_et", "vdfun_et", "makeSymmetric")) %dopar% {
        snum <- cmat[, i]
        nllh_ets(par, matrix(z[, snum], ncol = jw), sites[snum, ], matrix(hit[, snum], ncol = jw),
          smooth = smooth, split = split,
      ...
      for (i in 1:njw) {
        snum <- cmat[, i]
        nllhjw[i] <- nllh_ets(par, matrix(z[, snum], ncol = jw), sites[snum, ], matrix(hit[, snum], ncol = jw),
          smooth = smooth, split = split,
          parallel = parallel, pfun = pfun, args1 = args1, args2 = args2, seed = seed
        )
      }
    ...
    if (parallel) {
      nllhjw <- foreach(i = 1:njw, .combine = cbind, .packages = "foreach", .export = c("nllh_et", "convertHit", "vfun_et", "vdfun_et", "makeSymmetric")) %dopar% {
        snum <- cmat[, i]
        nllh_ets(par, z[, snum], sites[snum, ], hit[, snum],
          smooth = smooth, split = split,
          parallel = parallel, pfun = pfun, args1 = args1, args2 = args2, seed = seed
        )
      }
      ...
      for (i in 1:njw) {
        snum <- cmat[, i]
        nllhjw[, i] <- nllh_ets(par, z[, snum], sites[snum, ], hit[, snum],
          smooth = smooth, split = split,
          parallel = parallel, pfun = pfun, args1 = args1, args2 = args2, seed = seed
        )
      }
...
nllh_etjw <- function(par, z, sites, hit, jw = 2, cmat, split = FALSE, parallel = FALSE,
  ...
  par <- par[1:2]
  nllh_etsjw(
    par = par, z = z, sites = sites, hit = hit, smooth = smooth, jw = jw, cmat = cmat,
...
nllh_etfrjw <- function(par, lDoF, range, z, sites, hit, jw = 2, cmat,
  ...
  smooth <- 2 * inv.logit(par)
  nllh_etsjw(
    par = c(lDoF, log(range)), z = z, sites = sites, hit = hit, smooth = smooth, jw = jw, cmat = cmat,
    split = split, parallel = parallel, pfun = pfun, args1 = args1, args2 = args2, seed = seed
  )
}
...
nllh_est <- function(par, z, sites, hit, acov1, acov2, split = FALSE, parallel = FALSE,
  ...
  par <- par[1:2]
  nllh_EST(
    par = par, z = z, sites = sites, hit = hit, smooth = smooth, alpha = Alpha, split = split, parallel = parallel,
    pfun = pfun, args1 = args1, args2 = args2, seed = seed
  )
}
...
nllh_estsa0 <- function(par, z, smooth, alpha, sites, hit, acov1, acov2, split = FALSE, parallel = FALSE,
  ...
  Alpha <- alpha + par[3] * acov1 + par[4] * acov2
  nllh_EST(
    par = par[1:2], z = z, sites = sites, hit = hit, smooth = smooth, alpha = Alpha, split = split, parallel = parallel,
    pfun = pfun, args1 = args1, args2 = args2, seed = seed
  )
}
  ...
  if (!split) {
    if (parallel) {
      nllhjw <- foreach(i = 1:njw, .combine = c, .packages = "foreach", .export = c("nllh_est", "convertHit", "vfun_est", "vdfun_est", "makeSymmetric")) %dopar% {
        snum <- cmat[, i]
        nllh_EST(par, matrix(z[, snum], ncol = jw), sites[snum, ], matrix(hit[, snum], ncol = jw),
          smooth = smooth, alpha = alpha[snum], split = FALSE,
          parallel = parallel, pfun = pfun, args1 = args1, args2 = args2, seed = seed
        )
      }
    } else {
      ...
      for (i in 1:njw) {
        snum <- cmat[, i]
        nllhjw[i] <- nllh_EST(par, matrix(z[, snum], ncol = jw), sites[snum, ], matrix(hit[, snum], ncol = jw),
          smooth = smooth, alpha = alpha[snum], split = FALSE,
          parallel = parallel, pfun = pfun, args1 = args1, args2 = args2, seed = seed
        )
      }
    ...
    if (parallel) {
      nllhjw <- foreach(i = 1:njw, .combine = cbind, .packages = "foreach", .export = c("nllh_est", "convertHit", "vfun_est", "vdfun_est", "makeSymmetric")) %dopar% {
        snum <- cmat[, i]
        nllh_EST(par, z[, snum], sites[snum, ], hit[, snum],
          smooth = smooth, alpha = alpha[snum], split = TRUE,
          parallel = parallel, pfun = pfun, args1 = args1, args2 = args2, seed = seed
        )
      }
    } else {
      ...
      for (i in 1:njw) {
        snum <- cmat[, i]
        nllhjw[, i] <- nllh_EST(par, z[, snum], sites[snum, ], hit[, snum],
          smooth = smooth, alpha = alpha[snum], split = TRUE,
          parallel = parallel, pfun = pfun, args1 = args1, args2 = args2, seed = seed
        )
      }
...
nllh_estjw <- function(par, z, sites, hit, acov1, acov2, jw = 2, cmat, split = FALSE, parallel = FALSE,
  ...
  par <- par[1:2]
  nllh_ESTjw(
    par = par, z = z, sites = sites, hit = hit, smooth = smooth, alpha = Alpha, jw = jw, cmat = cmat,
    split = split, parallel = parallel, pfun = pfun, args1 = args1, args2 = args2, seed = seed
  )
}
...
vdfun_est <- function(z, sites, DoF, lambda, smooth, alpha, slst = list(1:d),
  ...
  vsfun <- function(z, sites, sv = 1:d, log.p = TRUE) {
    ...
    mpluss <- mplus[sv]
    mpluso <- mplus[-sv]
    alphastars <- alphastar[sv]
    alphastaro <- alphastar[-sv]
    zms <- zs * mpluss
    zmo <- zo * mpluso
